...
const tools = [
  {
    ...
    description: "Generate stories with local context.",
    icon: BookText,
  },
  {
    id: "worksheet",
    title: "Worksheet Wizard",
    description: "Create worksheets from lesson text.",
    icon: ClipboardEdit,
  },
  {
    id: "explainer",
    title: "Simple Explainer",
    description: "Explain topics with simple analogies.",
    icon: Lightbulb,
  },
  {
    id: "planner",
    title: "Lesson Planner",
    description: "Generate 5-day lesson plans.",
    icon: GraduationCap,
  },
  {
    id: "game",
    title: "Game Time",
    description: "Play simple, interactive games.",
    icon: Gamepad2,
  },
  {
    id: "analyzer",
    title: "Student Analyzer",
    description: "Analyze student performance and get insights.",
    icon: ChartPie,
  },
];
